...
public class DatosCampeonatoAbandonosFinal
{
     ...
     private void initData(Organizacion organizacion)
    {
        ...
        dSMWomen.insertarBicicleta(new Bicicleta("SCOTT CONTESSA ADDICT RC 15",Peso.PESADA));
        ...
        dSMWomen.insertarCiclista(new CiclistaEstrella("LIPPERT", Habilidad.LENTA, 1160, dSMWomen));
        dSMWomen.insertarCiclista(new CiclistaExperimentado("LABOUS", Habilidad.BUENA, 1150, dSMWomen));
     
        //constructor de bicicletas pide ( String nombre, Peso peso)
        //constructor de bicicletas rápidas pide ( String nombre, Peso peso, double velocidad extra)
        trekSegafredoWomen.insertarBicicleta(new Bicicleta("TREK Madone SLR 9 eTap Gen 7",Peso.LIGERA));
        ...
        //constructor de ciclistas pide (String nombre , Habilidad habilidad , double energia, Equipo equipo)
        trekSegafredoWomen.insertarCiclista(new CiclistaEstrella("BALSAMO", Habilidad.LENTA,1180, trekSegafredoWomen));
        ...
        movistarWomen.insertarBicicleta(new Bicicleta("CANYON Aeroad CF SLX 8 Disc Di2",Peso.NORMAL));
        movistarWomen.insertarBicicleta(new BicicletaPrototipo("CANYON Endurace CF SLX 9 Di2",Peso.PESADA));
        //constructor de ciclistas pide (String nombre , Habilidad habilidad , double energia, Equipo equipo)
        movistarWomen.insertarCiclista(new CiclistaEstrella("VAN VLEUTEN", Habilidad.BUENA,1200, movistarWomen));
        movistarWomen.insertarCiclista(new CiclistaExperimentado("NORSGAARD", Habilidad.NORMAL,1145, movistarWomen));
        movistarWomen.insertarCiclista(new CiclistaNovato("SIERRA", Habilidad.LENTA, 1110, movistarWomen));   
    }
