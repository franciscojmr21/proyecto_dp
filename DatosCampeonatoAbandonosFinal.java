...
public class DatosCampeonatoAbandonosFinal
{
     ...
     private void initData(Organizacion organizacion)
    {
        ...
        Etapa etapa2 = new EtapaImpl("compleja intermedia", Dificultad.COMPLEJA, Distancia.INTERMEDIA);
        ...
        Etapa etapa5 = new EtapaImpl("compleja larga", Dificultad.COMPLEJA, Distancia.LARGA);
